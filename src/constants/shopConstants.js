...
export const CAT_LABELS = { all:'Todos', tema:'Temas', avatar:'Personagens', utilidade:'Extras' }

export const CAT_DESC = {
  all:       'Todos os itens disponíveis',
  tema:      'Temas visuais para personalizar o app',
  avatar:    'Personagens para o seu perfil',
  utilidade: 'Ferramentas e recursos extras',
}